...
rho = - 0.13; % potentiation vs. depression threshold, adapted to inputs
%%
for trial = 1:ntrials
    % Initialization 
    ...
    for branch=1:n_branch
        ...
        dMat{branch} = normpdf(pdist2(pos{branch},pos{branch}), 0 , sigma_het)*(sqrt(2*pi)*sigma_het);
    ...
    save(['main' num2str(trial) '.mat'], ... 
         'T','saving_W', 'saving_ampVM', 'saving_zVM', 'saving_fr', 'saving_eye', 'saving_angles', ...
         'saving_PRE', 'saving_POST', 'saving_Ath', 'pos', 'dMat', 'dSoma', ...
