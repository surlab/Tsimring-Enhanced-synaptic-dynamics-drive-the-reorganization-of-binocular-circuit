function all_median_resp_dists = histogram_shuffled_and_resp_pair_distances(bins,all_resps_dists_by_session,shuffled_dists_by_session, days)

sessions = fieldnames(all_resps_dists_by_session);
for s = 1:length(sessions)
    figure("Name",sessions{s})
    all_median_resp_dists = [];
    ...
    for d = 1:length(days)
        ...
        all_mean_resp_dists = [all_median_resp_dists; median_resp_dists];
