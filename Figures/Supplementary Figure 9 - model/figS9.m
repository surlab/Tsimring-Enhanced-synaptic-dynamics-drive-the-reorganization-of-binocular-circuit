...
% for Fig S9
% - need to load results from figS9data folder
%%%%%%%
clear all
%% Parameters
ntrials = 20;
...
for col = 1:3
for trial= 1:ntrials
    load(['figS9data/data' num2str(row) num2str(col) '_' num2str(trial) '.mat'])     % Loop over the two timepoints (before and after plasticity)
