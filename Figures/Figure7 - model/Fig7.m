...
%% Panel D (left): Plot the spine activity of pooled experimental data
load('/Volumes/GoogleDrive-108846495442099470486/My Drive/Sur Lab/Manuscripts/SpineDevelopment/Figures/Figure7 - model/ca_event_rate_retained_lost_added.mat')
...
load('/Volumes/GoogleDrive-108846495442099470486/My Drive/Sur Lab/Manuscripts/SpineDevelopment/Figures/Figure7 - model/active_trials_retained_lost_added.mat')
...
load('/Volumes/GoogleDrive-108846495442099470486/My Drive/Sur Lab/Manuscripts/SpineDevelopment/Figures/Figure7 - model/correlation_analysis.mat', 'all_resps_dists_by_session'); %experimental data 
load('/Volumes/GoogleDrive-108846495442099470486/My Drive/Sur Lab/Manuscripts/SpineDevelopment/Figures/Figure7 - model/pair_dists_corrs_correct.mat') %simulation data
load('/Volumes/GoogleDrive-108846495442099470486/My Drive/Sur Lab/Manuscripts/SpineDevelopment/Figures/Figure7 - model/pair_precisedists_corrs.mat', 'precise_dists') %simulation data
