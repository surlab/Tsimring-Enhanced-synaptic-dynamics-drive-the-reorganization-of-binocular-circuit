...
function create_table_tracked_spines_function(distance_path, processed_path, spinefile, savefile)
...
extract_columns = {'all_roi_inds','nonresp','resp','soma_resp',...
                        ...
                        'all_ori_alignment_vector','all_dir_corr', 'all_fano_factor', ...
                        'co_activity_trial', 'neighbor_spine_distance', 'neighbor_spine_resp', 'all_shaft_corr', 'mean_co_activity_trial',...
                        'co_activity_ISI', 'mean_co_activity_ISI', 'mean_co_activity_mean_amp', 'mean_co_activity_trial_amp',...
...
save(fullfile(processed_path, savefile), 'D1_D5_table', 'D5_D10_table');
%%
